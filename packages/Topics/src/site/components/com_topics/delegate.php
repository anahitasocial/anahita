 ...
 * @link       http://www.anahitapolis.com
 */
class ComTopicsDelegate extends ComAppsDomainDelegateDefault
{	
    /**
    ...
    */
    ...
    {
        $config->append(array(
            'default_assignments' => array('person'=>self::ASSIGNMENT_NEVER,'group'=>self::ASSIGNMENT_ALWAYS)
        ));
	...
	public function onDestroyNodes(KEvent $event)
	{
	    ...
	    $this->_nullifyRecords($ids, 'topics_topics');
	}
}