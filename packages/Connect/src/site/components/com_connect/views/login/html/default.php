...
<button data-request-redirect="true" data-trigger="BS.showPopup" data-bs-showpopup-url="<?= @route('option=com_people&view=session&layout=modal_simple&ajax=1') ?>" class="btn btn-large">
