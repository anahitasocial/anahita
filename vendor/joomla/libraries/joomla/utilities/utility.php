...
class JUtility
{
	/**
 	 ...
 	 * @return boolean True on success
  	 */
	static public function sendMail($from, $fromname, $recipient, $subject, $body, $mode=0, $cc=null, $bcc=null, $attachment=null, $replyto=null, $replytoname=null )
	{
	...
	/**
 	 ...
 	 * @return string
 	 */
	static public function getHash( $seed )
	{
	...
	static public function getToken($forceNew = false)
	{
		...
		$hash = JUtility::getHash( $viewer->id . $session->getToken($forceNew));
	...
	/**
 	 ...
 	 * @since	1.5
 	 */
	static public function parseAttributes( $string )
	{
	 ...
	 * @static
	 */
	static public function dump( &$var, $htmlSafe = true )
	{
