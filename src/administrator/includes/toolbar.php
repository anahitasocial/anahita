...
class JToolBarHelper
{
     ...
     * @param bool True if required to check that a standard list item is checked
     * @param bool True if required to include callinh hideMainMenu()
     *
     * @since 1.0
     */
     ...
     * @param bool Use the help file in the component directory
     *
     * @since 1.0
     */
     ...
     * @since 1.0
     */
    public function editCss($task = 'edit_css', $alt = 'Edit CSS')
    {
        $bar = &JToolBar::getInstance('toolbar');
     ...
     * @since 1.0
     */
    public function deleteListX($msg = '', $task = 'remove', $alt = 'Delete')
    {
        $bar = &JToolBar::getInstance('toolbar');
