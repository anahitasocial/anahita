...
class LibBaseControllerState extends KConfig
{
     ...
     *
     * @param   bool If TRUE only retrieve unique state values, default FALSE
     *
     ...
     *
     * @return bool TRUE if the state is unique, otherwise FALSE.
     */
     ...
     *
     * @return bool True if unique state is valid, false otherwise.
     */
