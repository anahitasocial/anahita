...
class AnServiceIdentifier implements AnServiceIdentifierInterface
{
    /**
     ...
     * @throws  AnServiceIdentifierException if the identfier is not valid
     */
     ...
     * @return void
     */
    public static function addLocator(AnServiceLocatorInterface $locator)
    {
