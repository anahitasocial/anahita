...
<form action="<?= @route('view=person&id='.$item->id) ?>" method="post" name="person-form" id="person-form" autocomplete="off">
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	        ...
	        <input required data-validate="username" data-remote="true" data-url="<?= @route('view=person', false ) ?>" type="text" id="person-username" class="input-block-level" name="username" pattern="<?= $usernamePattern ?>" value="<?= $item->username ?>" maxlength="25" minlength="6" />
	    </div>
	</div>
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	       ...
	       <input required data-validate="email" data-remote="true" data-url="<?= @route('view=person', false) ?>" type="email" name="email" pattern="<?= $emailPattern ?>" id="person-email" class="input-block-level" maxlength="100" value="<?= $item->email ?>"  />
	    </div>
	</div>
