...
<div class="row">
    <div class="span12">
        <form action="https://localhost/anahitapolis/rmdstudio/www/people?layout=list" id="an-filterbox" class="form-inline" name="an-filterbox" method="get">             
            ...
            <label class="checkbox">
                <input type="checkbox" name="filter[disabled]"> <?= @text('COM-PEOPLE-FILTER-DISABLED') ?>
            </label>    
        </form>
    </div>
</div>
