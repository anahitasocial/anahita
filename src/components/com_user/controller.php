...
class UserController extends JController
{
	...
	function register_save()
	{
		...
		// Don't Send registration confirmation mail, becuase emailing plain text passwords is a terrible idea.
	...
	function _sendMail(&$user, $password)
	{
		...
		if ( $useractivation == 1 ){
			$message = sprintf ( JText::_( 'SEND_MSG_ACTIVATE' ), $name, $sitename, $siteURL."index.php?option=com_user&task=activate&activation=".$user->get('activation'), $siteURL);
		} else {
